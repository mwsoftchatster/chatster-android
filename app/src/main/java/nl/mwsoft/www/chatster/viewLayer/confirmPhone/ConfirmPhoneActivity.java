...
public class ConfirmPhoneActivity extends AppCompatActivity implements ConfirmPhoneDialogFragment.ConfirmPhoneDialogListener {
    ...
    @BindView(R.id.spConfirmCountryCode)
    Spinner spConfirmCountryCode;
    @BindView(R.id.etConfirmPhoneNumber)
    EditText etConfirmPhoneNumber;
    @BindView(R.id.etVerifyCode)
    EditText etVerifyCode;
    @BindView(R.id.btnConfirmNext)
    Button btnConfirmNext;
    @BindView(R.id.btnConfirmVerify)
    Button btnConfirmVerify;
    @BindView(R.id.tvConfirmInfoPP)
    TextView tvConfirmInfoPP;
    ...
    private void processUserAlreadyExists(long userId) {
        hideKeyBoard();
