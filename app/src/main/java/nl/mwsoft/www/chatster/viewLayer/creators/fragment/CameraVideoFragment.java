...
import nl.mwsoft.www.chatster.viewLayer.creators.AutoFitTextureView;
...
//                + System.currentTimeMillis() + ".mp4";
        ...
        String fileName = ConstantRegistry.CHATSTER_VIDEO_NAME_PART1.concat(timeStamp).
                concat(ConstantRegistry.CHATSTER_VIDEO_NAME_PART2);
        File storageDir = context.getExternalFilesDir(Environment.DIRECTORY_PICTURES);

        File temp = File.createTempFile(
                fileName,  /* prefix */
                ConstantRegistry.CHATSTER_MP4_EXTENSION,         /* suffix */
                storageDir      /* directory */
        );
        videoUri = FileProvider.getUriForFile(creatorsActivity,
            ...
            mCameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            // UI
                            Picasso.with(getActivity()).load(R.drawable.recording_256).into(mButtonVideo);
    ...
    private void stopRecordingVideo() {
        ...
        Picasso.with(getActivity()).load(R.drawable.not_recording_256).into(mButtonVideo);
        // Stop recording
        mMediaRecorder.stop();
...
//            Log.d(TAG, "Video saved: " + mNextVideoAbsolutePath);
            creatorsActivity.handleCaptureVideo(videoUri, ConstantRegistry.VIDEO);
        }
